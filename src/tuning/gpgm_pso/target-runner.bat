...
SET "exe=cargo run --release --package exploration-mechanisms --bin irace_gpgm_pso --"
SET "fixed_params= --population-size 50 --inertia-weight 0.5034 --c1 1.0519 --c2 2.3403"
